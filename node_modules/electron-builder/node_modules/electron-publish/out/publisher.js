...
class Publisher {
    ...
    createProgressBar(fileName, size) {
        if (this.context.progress == null) {
            ...
            return this.context.progress.createBar(`[:bar] :percent :etas | ${(0, (_chalk || _load_chalk()).green)(fileName)} to ${this.providerName}`, Object.assign({ total: size }, progressBarOptions));
        }
    }
