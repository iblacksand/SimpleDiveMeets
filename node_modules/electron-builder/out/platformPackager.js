    ...
    doPack(outDir, appOutDir, platformName, arch, platformSpecificBuildOptions, targets) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            if (_this2.info.isPrepackedAppAsar) {
                ...
                taskManager.addTask((0, (_fs || _load_fs()).copyDir)(appDir, _path.join(resourcesPath, "app"), filter, transformer));
            } else {
                ...
                taskManager.addTask(new (_asarUtil || _load_asarUtil()).AsarPackager(appDir, resourcesPath, asarOptions, fileMatcher == null ? null : fileMatcher.createFilter(), transformer).pack(filter, isElectronCompile, _this2));
            }
